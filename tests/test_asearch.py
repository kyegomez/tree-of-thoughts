...
@pytest.mark.parametrize(
    "initial_prompt, num_thoughts, max_steps, pruning_threshold, expected",
    [
...
def test_solve(
    ...
    asearch_fixture.model.generate_thoughts.return_value = [
        "thought1",
        "thought2",
    ]
    actual = asearch_fixture.solve(
        initial_prompt, num_thoughts, max_steps, pruning_threshold
    )
